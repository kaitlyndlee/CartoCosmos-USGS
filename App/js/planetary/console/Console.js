 ...
 *   targetInfoDiv    - string for target info div id. This element should already exist on the page. Default: 'ConsoleTargetInfo'
 *   projButtonsDiv   - string for projection buttons div id. This element should already exist on the page. Default: 'ConsoleProjectionButtons'
 *   lonLatSelectsDiv - string for lon/lat selects div id. This element should already exist on the page. Default: 'ConsoleLonLatSelects'
 *   keyDiv           - string for keys div id (the legend). This element should already exist on the page. Default: 'ConsoleKey'
 */
function Console(astroMap, consoleSettings) {
  // instance variables
  ...
  // console divs
  this.targetInfoDiv = "ConsoleTargetInfo";
  this.projButtonsDiv = "ConsoleProjectionButtons";
  this.lonLatSelectsDiv = "ConsoleLonLatSelects";
  this.keyDiv = "ConsoleKey";
  // this.featureFinderDiv = "astroFeatureFinder";

  //element ids . . . only one per page
  this.targetImgId = "ConsoleTargetImage";
  ...
  this.lonDirSelectId = "ConsoleLonDirSelect";
  this.lonDomSelectId = "ConsoleLonDomSelect";
  this.latTypeSelectId = "ConsoleLatTypeSelect";
  this.mouseLonLatDiv = "ConsoleLonLat";
 ...
 */
// Console.prototype.targetInfoSetup = function() {
...
//   targetImg.className ='ConsoleTargetImg';
//   container.appendChild(targetImg);

//   var targetSpan = document.createElement("span");
//   targetSpan.className ='ConsoleTargetName';
 ...
 */
Console.prototype.mouseLonLatSetup = function() {
  var container = document.getElementById(this.targetInfoDiv);

  var lonLatTitle = document.createElement("div");
  lonLatTitle.className ='ConsoleLonLatTitle';
  ...
  lonLatDiv.className = 'ConsoleLonLat';
 ...
 * Requires JQuery
 */
// Console.prototype.featureFinderSetup = function() {
...
//   ftSelect.className = "ConsoleSelect";
...
//   fnSelect.className = "ConsoleSelect";
...
//
// Console.prototype.featureFinderLoadTypes = function(target) {
 ...
 */
Console.prototype.projButtonsSetup = function() {
  ...
  northPoleImg.className ='ConsoleProjectionButton';
  var that = this;
  ...
  cylindricalImg.className ='ConsoleProjectionButton';
  ...
  southPoleImg.className ='ConsoleProjectionButton';
 ...
 * Returns: nothing
 */
Console.prototype.lonLatSelectsSetup = function(lonDir, lonDom) {
  ...
  lonDirSelect.className = "ConsoleSelect";
  // create options
  ...
  lonDomSelect.className = "ConsoleSelect";
  ...
  latTypeSelect.className = "ConsoleSelect";
